const InfoCard = (props: Props) => {
	...
	return (
		<>
			<div className="flex flex-col text-left bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-[#666666] dark:hover:bg-gray-700">
